...
create index bot_events_at on bot_events (at desc);
...
language sql as $$
  update parents
     set bot_state = 'active', paused_until = null
...
revoke all on function cron_housekeeping() from public, anon, authenticated;
