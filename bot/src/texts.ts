...
const ru = {
  ...
  milestones: {
    7:   (_n: string, c: string) => `И кстати: сегодня ровно неделя, как мы с вами встречаем утро вместе. ${c} каждый день получает ваше «всё хорошо» — и это лучшая новость в его дне.`,
